...
factor equasions calc, zpp calculator, greatest common factor calculator, Line of symmetrey calc,standad form equasion calculator, vetex form grapher standard form grapher, exponential function grapher, various bug fixes) Physics Calc(lorentz factor)