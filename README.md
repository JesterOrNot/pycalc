...
##### v1.12 #####
New Features: Geomometry Calculator(trig table) Algebra Calculator(absolute value,also improved on les  by removing the error in which the program crashedd when dividing by 0, factor equasions) Physics Calc(lorentz factor)